...
### Developed by
[Angad Singh](https://www.github.com/wangjing) ([@wangjing](https://www.twitter.com/wangjing))

### Benchmark:
[![API](https://img.shields.io/badge/API-9%2B-brightgreen.svg?style=flat)](https://android-arsenal.com/api?level=9) <a href="http://www.methodscount.com/?lib=com.github.wangjing%3Afilepicker%3A1.1.1"><img src="https://img.shields.io/badge/Methods and size-271 | 43 KB-e91e63.svg"/></a>

### Where to Find:
[ ![Download](https://api.bintray.com/packages/wangjing/maven/filepicker/images/download.svg) ](https://bintray.com/wangjing/maven/filepicker/_latestVersion) [![Maven Central](https://maven-badges.herokuapp.com/maven-central/com.github.wangjing/filepicker/badge.svg)](https://maven-badges.herokuapp.com/maven-central/com.github.wangjing/filepicker) [![Android Arsenal](https://img.shields.io/badge/Android%20Arsenal-FilePicker-blue.svg?style=flat)](http://android-arsenal.com/details/1/3950)

### Read all about internal classes and functions in the [wiki](https://github.com/wangjing/android-filepicker/wiki).
...
```gradle
    compile 'com.github.wangjing:filepicker:1.1.1'
```
...
1. Start by declaring [FilePickerPreference](https://github.com/wangjing/android-filepicker/wiki/filepicker-preference) in your settings xml file as:

    ```xml
       <com.github.wangjing.filepicker.view.FilePickerPreference
...
### Note:
[FilePickerPreference](https://github.com/wangjing/android-filepicker/wiki/filepicker-preference) stores selected directories/files as a `String`. It delimits multiple files/directories using ':' `char`.

## Read more on implementation [here](https://github.com/wangjing/android-filepicker/wiki/Implementation).

### Screenshot

#### Theme.Black

![Screenshot 1](https://raw.githubusercontent.com/wangjing/android-filepicker/master/screenshots/theme_black.png)

#### Theme.Holo

![Screenshot 2](https://raw.githubusercontent.com/wangjing/android-filepicker/master/screenshots/theme_holo.png)

#### Theme.Holo.Light

![Screenshot 3](https://raw.githubusercontent.com/wangjing/android-filepicker/master/screenshots/theme_holo_light.png)

#### Theme.Material

![Screenshot 4](https://raw.githubusercontent.com/wangjing/android-filepicker/master/screenshots/theme_material.png)

#### Theme.DeviceDefault

![Screenshot 5](https://raw.githubusercontent.com/wangjing/android-filepicker/master/screenshots/theme_device_default.png)

### Performance

#### GPU Overdraw

![Performance 1](https://raw.githubusercontent.com/wangjing/android-filepicker/master/screenshots/performance_overdraw.png)

#### GPU Rendering

![Performance 2](https://raw.githubusercontent.com/wangjing/android-filepicker/master/screenshots/profile_gpu_rendering.png)
